(function (global, factory) {
  ...
  $export$3($export$3.S, 'Date', { now: function () { return new Date().getTime(); } });
  ...
  $export$4($export$4.P, 'Function', { bind: require('./_bind') });
  ...
  $export$6($export$6.P + $export$6.R, 'Promise', { 'finally': function (onFinally) {
    var C = speciesConstructor$1(this, core.Promise || global$3.Promise);
